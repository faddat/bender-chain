...
import { Add } from "./module/types/benderchain/add";
import { Post } from "./module/types/benderchain/post";
...
const getDefaultState = () => {
    return {
        ...
        PostAll: {},
        _Structure: {
            Add: getStructure(Add.fromPartial({})),
...
export default {
    ...
    actions: {
        init({ dispatch, rootGetters }) {
            console.log('Vuex module: faddat.benderchain.benderchain initialized!');
